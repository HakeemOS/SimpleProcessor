...
HD_PWD='C:/Users/squid/OneDrive/Documents/Vivado/2023/SimpleProcessor/SimpleProcessor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testCtrl_s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testCtrl_s.tcl
